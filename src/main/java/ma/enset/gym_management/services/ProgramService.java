...
public interface ProgramService {
    ...
    List<ExerciseDto> listExercisesOfProgram(Long program_id) throws ProgramIdNotFoundException, ListExercisesOfProgramNotFoundException;

    ProgramDto createProgram(ProgramDto programDto) throws ProgramAlreadyExistsException;
    ProgramDto updateProgram(Long programId);
    ProgramDto deleteProgram(Long programId);
